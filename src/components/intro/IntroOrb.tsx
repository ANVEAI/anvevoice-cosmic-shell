...
export const IntroOrb = ({ size = "large", className = "" }: IntroOrbProps) => {
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      {/* Golden glowing ring - Saturn style orbit */}
      <motion.div
        className="absolute"
        style={{
          left: "50%",
          top: "50%",
          width: isSmall ? "105px" : "420px",
          ...
          background: `
            radial-gradient(ellipse at center, 
              transparent 30%,
              hsl(45 100% 60% / 0.2) 40%,
              hsl(45 100% 65% / 0.5) 47%,
              hsl(45 100% 70% / 0.8) 50%,
              hsl(45 100% 65% / 0.5) 53%,
              hsl(45 100% 60% / 0.2) 60%,
              transparent 70%
            )
          `,
          boxShadow: `
            0 0 ${isSmall ? 15 : 40}px hsl(45 100% 65% / 0.8),
            0 0 ${isSmall ? 25 : 60}px hsl(45 100% 60% / 0.6),
            inset 0 0 ${isSmall ? 10 : 30}px hsl(45 100% 70% / 0.6),
            inset 0 0 ${isSmall ? 20 : 50}px hsl(45 100% 65% / 0.4)
          `,
      ...
      {/* Secondary purple ring - inner orbit */}
      <motion.div
        className="absolute"
        style={{
          left: "50%",
          top: "50%",
          width: isSmall ? "95px" : "380px",
          height: isSmall ? "26px" : "104px",
          borderRadius: "50%",
          transform: "translate(-50%, -50%) rotateX(75deg)",
          background: `
            radial-gradient(ellipse at center, 
              transparent 35%,
              hsl(260 100% 70% / 0.3) 45%,
              hsl(260 100% 75% / 0.6) 50%,
              hsl(260 100% 70% / 0.3) 55%,
              transparent 65%
            )
          `,
          boxShadow: `
            0 0 ${isSmall ? 20 : 50}px hsl(260 100% 70% / 0.5),
            inset 0 0 ${isSmall ? 15 : 40}px hsl(260 100% 75% / 0.4)
          `,
      ...
      {/* Golden ring particles - cosmic dust on outer ring */}
      {[...Array(isSmall ? 16 : 28)].map((_, i) => {
        const angle = (i * 2 * Math.PI) / (isSmall ? 16 : 28);
        const radiusX = isSmall ? 51 : 204;
        const radiusY = isSmall ? 14 : 56;
        return (
          <motion.div
            ...
            style={{
              ...
              background: i % 3 === 0 ? "hsl(45 100% 70%)" : i % 3 === 1 ? "hsl(45 100% 65%)" : "hsl(50 100% 75%)",
              boxShadow: `0 0 ${isSmall ? 8 : 15}px currentColor`,
              filter: "blur(0.5px)",
            }}
            animate={{
              opacity: [0.4, 1, 0.4],
      ...
      {/* Purple/blue ring particles - cosmic dust on inner ring */}
      {[...Array(isSmall ? 14 : 24)].map((_, i) => {
        const angle = (i * 2 * Math.PI) / (isSmall ? 14 : 24);
        const radiusX = isSmall ? 46 : 184;
        const radiusY = isSmall ? 12 : 48;
        return (
          <motion.div
            key={`purple-particle-${i}`}
            className="absolute rounded-full"
            style={{
              width: isSmall ? "1.5px" : "2.5px",
              height: isSmall ? "1.5px" : "2.5px",
              left: `${(isSmall ? 32 : 160) + Math.cos(angle) * radiusX}px`,
              top: `${(isSmall ? 32 : 160) + Math.sin(angle) * radiusY}px`,
              background: i % 2 === 0 ? "hsl(260 100% 75%)" : "hsl(240 100% 80%)",
