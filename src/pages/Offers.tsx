...
const offers = [{
  ...
  features: ["Up to 10,000 voice interactions/month", "2 website integrations", "Basic analytics dashboard", "Email support", "Custom voice responses", "Multi-language support (5 languages)"],
  icon: Sparkles,
  ...
  features: ["Up to 50,000 voice interactions/month", "10 website integrations", "Advanced analytics & insights", "Priority email & chat support", "Custom voice training", "Multi-language support (15 languages)", "Form automation", "CRM integrations"],
  icon: Zap,
  ...
  features: ["Unlimited voice interactions", "Unlimited website integrations", "Custom analytics & reporting", "24/7 dedicated support", "AI model customization", "All languages supported", "Advanced workflow automation", "White-label solution", "On-premise deployment option", "SLA guarantees"],
  icon: TrendingUp,
              ...
              delay: index * 0.1
                  ...
                  <Card className={`relative overflow-hidden p-8 h-full bg-gradient-to-br ${offer.gradient} border-2 hover:border-primary/50 transition-all hover:shadow-elevated group`}>
                    ...
                    <ul className="space-y-3 mb-8">
                      {offer.features.map((feature, idx) => <li key={idx} className="flex items-start gap-3">
