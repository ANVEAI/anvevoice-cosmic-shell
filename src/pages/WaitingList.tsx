            ...
            <Card className="p-4 sm:p-8 bg-gradient-card shadow-elevated">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 sm:space-y-6">
                <div className="space-y-1 sm:space-y-2">
                  ...
                  <Input id="fullName" data-field="fullName" placeholder="John Doe" {...register("fullName")} className={errors.fullName ? "border-destructive" : ""} />
                ...
                <div className="space-y-1 sm:space-y-2">
                  ...
                  <Input id="phoneNumber" data-field="phoneNumber" type="tel" placeholder="+1 (555) 123-4567" {...register("phoneNumber")} className={errors.phoneNumber ? "border-destructive" : ""} />
                  {errors.phoneNumber && <p className="text-sm text-destructive">{errors.phoneNumber.message}</p>}
                </div>

                <div className="space-y-1 sm:space-y-2">
                  <Label htmlFor="website">Website *</Label>
                  <Input id="website" data-field="website" type="text" placeholder="yourcompany.com" {...register("website")} className={errors.website ? "border-destructive" : ""} />
